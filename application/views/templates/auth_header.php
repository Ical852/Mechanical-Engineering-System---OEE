...
<head>
  ...
  <link rel="shortcut icon" href="<?php echo base_url('assets/img/login.png');?>" type="image/x-icon">
  <link rel="icon" href="<?php echo base_url('assets/img/login.png');?>" type="image/x-icon">
