                                    ...
                                    <div class="container">
                                     ...
                                     <script type="text/javascript" src="<?php echo base_url('assets2/js/loader.js');?>"></script>
                                          ...
                                          function load_monthwise_data(date, title)
                                          {
                                              ...
                                              $.ajax({
                                                  url:"<?php echo base_url(); ?>testing1/fetch_data",
                                                  method:"POST",
                                                  data:{date:date},
                                                  dataType:"JSON",
                                          ...
                                          function load_monthwise_data1(nama_mesin, title)
                                          {
                                              var temp_title = title + ' ' + nama_mesin;
                                              $.ajax({
                                                  url:"<?php echo base_url(); ?>testing1/fetch_data1",
                                                  method:"POST",
                                          ...
                                          function load_monthwise_data2(date, nama_mesin, title)
                                          {
                                              var temp_title = title + ' ' + nama_mesin;
                                              $.ajax({
                                                  url:"<?php echo base_url(); ?>testing1/fetch_data2",
                                                  method:"POST",
                                                  data:{'date':date ,'nama_mesin':nama_mesin},
                                                  dataType:"JSON",
                                                  success:function(data)
                                                  {
                                                      drawMonthwiseChart(data, temp_title);
                                          ...
                                          $(document).ready(function(){
                                              $('#nama_mesin').change(function(){
                                                  ...
                                                  if(nama_mesin != '')
                                                  {
                                                      load_monthwise_data1(nama_mesin, 'Persentase Oee Pada Mesin :');
                                                  }
                                              });
                                          });

                                          $(document).ready(function(){
                                              $('#date, #nama_mesin').change(function(){
                                                  var date = $(this).val();
                                                  var nama_mesin = $(this).val();
                                                  if(date = '' && nama_mesin != '')
                                                  {
                                                      load_monthwise_data2(nama_mesin, 'Persentase Oee Pada Mesin :');
                                                  }
                                              });
                                          });
