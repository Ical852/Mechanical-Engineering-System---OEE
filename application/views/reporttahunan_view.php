                        ...
                        <div class="main-content-inner"><!-- /.main-content -->
                              <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                                    <ul class="breadcrumb">
                                          ...
                                          <li class="active">Data Persentase Per Tahun</li>
                                    </ul><!-- /.breadcrumb -->
                              </div>
                                     ...
                                     <table id="datatable" class="table table-striped table-bordered table-hover" style="width: 100%;">
                                          <thead>
                                              <tr> 
                                                  ...
                                                  <th class="center" width="10%">Tahun</th>
...
$( "li.report4" ).addClass( "active" );

    var myTable =$('#datatable').DataTable({
      "ajax": {
        type   : "POST",
        url    : "<?php echo base_url(); ?>reporttahunan/daftar_data/",
        data   : function(d) {
