                              ...
                              <div class="page-content">
                                ...
                                <div class="ace-settings-container " id="ace-settings-container">
                                  ...
                                  <div class="ace-settings-box clearfix " id="ace-settings-box">
                                    ...
                                    <div class="row">
                                          <div class="col-lg-12">
                                                <h1 class="center"><strong>Pelayanan Supplier Terkini</strong></h1><br>
                                                ...
                                                <table class="table table-hover">
                                                  <thead>
                                                    <tr>
                                                      ...
                                                      <th scope="col">Pelayanan Puma Jual</th>
                                                      <th scope="col">Pelayanan Keluhan</th>
                                                  ...
                                                  <tbody>
                                                      <?php $no = 0;
                                                      foreach ($dataevaluasi as $data) : $no++ ?>
                                                    <tr>
                                                      <th scope="row"><?= $no ?></th>
                                                      <td><?= $data->date ?></td>
                                                      <td><?= $data->supplier ?></td>
                                                      ...
                                                      <td><?= $data->kualitas ?></td>
                                                      <td><?= $data->pelayanan_pumajual ?></td>
                                                      <td><?= $data->pelayanan_keluhan ?></td>
                                                ...
                                                <a href="<?php echo site_url ('dataevaluasi') ?>"><button class="btn btn-primary"><strong style="color: black;">Ke Detail Data Evaluasi</strong></button></a>

                                                <a href="<?php echo site_url ('evaluasi') ?>"><button class="btn btn-success"><strong style="color: black;">Tambah Data Evaluasi Supplier</strong></button></a>
                                          </div><!-- /.col -->
                                    </div><hr><br>
                              </div><!-- /.page-content -->
                        </div>
