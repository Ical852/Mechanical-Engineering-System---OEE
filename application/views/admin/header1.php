...
<head>
      ...
      <title>SPARE PART CSAS</title>

      <link rel="shortcut icon" href="<?php echo base_url('assets/img/sparepart.png');?>" type="image/x-icon">
      <link rel="icon" href="<?php echo base_url('assets/img/sparepart.png');?>" type="image/x-icon">
      ...
      <body class="no-skin">
            <div id="navbar" class="navbar navbar-default          ace-save-state" style="background-color: #1A8237">
                        ...
                        <div class="navbar-buttons navbar-header pull-right" role="navigation">
                              <ul class="nav ace-nav" >
                                    <li class="dropdown-modal" >
                                          <a data-toggle="dropdown" href="#" class="dropdown-toggle" style="background-color: #166912">
