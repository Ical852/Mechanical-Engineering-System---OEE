                              ...
                              <div class="page-content">
                                ...
                                <div class="ace-settings-container " id="ace-settings-container">
                                  ...
                                  <div class="ace-settings-box clearfix " style="border-color: #34495E;" id="ace-settings-box">
                                    ...
                                    <link rel="stylesheet" type="text/css" href="<?php echo base_url('assets1/css/morris.css');?>">
                                          <script type="text/javascript" src="<?php echo base_url('assets1/js/jquery.min.js');?>"></script>
                                          <script type="text/javascript" src="<?php echo base_url('assets1/js/raphael-min.js');?>"></script>
                                          <script type="text/javascript" src="<?php echo base_url('assets1/js/morris.min.js');?>"></script>
                                    ...
                                    <div class="row">
                                          ...
                                          <h1 class="center"><strong>Data Persentase Tiap Mesin Terkini</strong></h1><br>
                                    <div class="row">
                                          <div class="col-lg-12">
                                          <div id="graph"></div>
                                          ...
                                          <script>
                                            Morris.Bar({
                                              ...
                                              data: <?php echo $data1;?>,
                                              xkey: ['nama_mesin'],
                                              ykeys: ['AvailRatio', 'Performance', 'Quality','OEE'],
                                              labels: ['Availibility', 'Performance', 'Quality','OEE']
                                            });
                                          </script>
                                          </div>
