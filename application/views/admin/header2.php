...
<head>
      ...
      <title>SERVICE AVL CSAS</title>

      <link rel="shortcut icon" href="<?php echo base_url('assets/img/service.png');?>" type="image/x-icon">
      <link rel="icon" href="<?php echo base_url('assets/img/service.png');?>" type="image/x-icon">
      ...
      <body class="no-skin">
            <div id="navbar" class="navbar navbar-default          ace-save-state" style="background-color: #DC8500">
                        ...
                        <div class="navbar-buttons navbar-header pull-right" role="navigation">
                              <ul class="nav ace-nav" >
                                    <li class="dropdown-modal" >
                                          <a data-toggle="dropdown" href="#" class="dropdown-toggle" style="background-color: #C57700">
