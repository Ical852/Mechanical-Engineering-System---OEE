                        ...
                        <div class="main-content-inner">
                              <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                                    <ul class="breadcrumb">
                                          ...
                                          <li class="active">Chart Persentase Data Tahunan</li>
                                    </ul><!-- /.breadcrumb -->
                              </div>
                                ...
                                <div class="ace-settings-container " id="ace-settings-container">
                                  ...
                                  <div class="ace-settings-box clearfix " style="border-color: #34495E;" id="ace-settings-box">
                                    ...
                                    <div class="pull-left width-50">
                                      ...
                                      <br />
                                      <h3 align="center">Grafik Persentase Data OEE Per Tahun</h3>
                                      <br />
                                      <div class="panel panel-default">
                                                <div class="panel-heading">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-3">
                                                            <p class="panel-title" style="text-align: right">Pilih Tahun :</p>
                                                        </div>
                                                        <div class="col-md-3">
                                          ...
                                          function load_monthwise_data(tahun, title)
                                          {
                                              var temp_title = title + ' ' + tahun;
                                              $.ajax({
                                                  url:"<?php echo base_url(); ?>chartyearly/fetch_data",
                                                  method:"POST",
                                                  data:{tahun:tahun},
                                                  dataType:"JSON",
                                          ...
                                          $(document).ready(function(){
                                              $('#tahun').change(function(){
                                                  ...
                                                  if(tahun != '')
                                                  {
                                                      load_monthwise_data(tahun, 'Persentase Data Oee Tahun :');
                                                  }
                                              });
                                          });

                                          $( "li.graph" ).addClass( "active open" );
                                          $( "li.graph3" ).addClass( "active" );
