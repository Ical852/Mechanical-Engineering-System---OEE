                        ...
                        <div class="main-content-inner">
                              <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                                    <ul class="breadcrumb">
                                          ...
                                          <li class="active">Chart Persentase Data Bulanan</li>
                                    </ul><!-- /.breadcrumb -->
                              </div>
                                ...
                                <div class="ace-settings-container " id="ace-settings-container">
                                  ...
                                  <div class="ace-settings-box clearfix " style="border-color: #34495E;" id="ace-settings-box">
                                    ...
                                    <div class="pull-left width-50">
                                      ...
                                      <br />
                                      <h3 align="center">Grafik Persentase Data OEE Per Bulan</h3>
                                      <br />
                                      <div class="panel panel-default">
                                                <div class="panel-heading">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-3">
                                                            <p class="panel-title" style="text-align: right">Pilih Bulan :</p>
                                                        </div>
                                                        <div class="col-md-3">
                                        ...
                                        <script type="text/javascript">
                                          ...
                                          function load_monthwise_data(bulan, title)
                                          {
                                              var temp_title = title + ' ' + bulan;
                                              $.ajax({
                                                  url:"<?php echo base_url(); ?>chartmonthly/fetch_data",
                                                  method:"POST",
                                                  data:{bulan:bulan},
                                                  dataType:"JSON",
                                          ...
                                          $(document).ready(function(){
                                              $('#bulan').change(function(){
                                                  ...
                                                  if(bulan != '')
                                                  {
                                                      load_monthwise_data(bulan, 'Persentase Data Oee Bulan :');
                                                  }
                                              });
                                          });

                                          $( "li.graph" ).addClass( "active open" );
                                          $( "li.graph2" ).addClass( "active" );
