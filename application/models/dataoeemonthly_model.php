...
class Dataoeemonthly_model extends CI_Model {
    ...
    {
        $i = 1;
        $data_oee = $this->db->query("SELECT * from oee_data_monthly");
    ...
    public function hapus()
    {
        $kodeOee = $this->input->post('id');
            ...
            if($this->db->simple_query("DELETE FROM oee_data_monthly WHERE id_oee_monthly = '$kodeOee'")){       
                $data['msg'][0] = "hapus";
